...
router.get("/:id", checkingId, getProductById);
/**
 * @swagger
 * /api/product/{id}:
 *   get:
...
router.post("/", handlerInputErrors, crearProduct);
/**
 * @swagger
 * /api/product:
 *   post:
...
router.put("/:id", checkingId, handlerInputErrors, updataProduct);
/**
 * @swagger
 * /api/product/{id}:
 *   put:
...
router.patch("/:id", checkingId, updataAvailability);
/**
 * @swagger
 * /api/product/{id}:
 *   patch:
...
router.delete("/:id", checkingId, deleteProduct);
/**
 * @swagger
 * /api/product/{id}:
 *   delete:
